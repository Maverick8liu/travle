...
<!--[if gte IE 9]><!-->
<script src="<%=basePath %>js/jquery-2.1.4.min.js" type="text/javascript"></script><!--<![endif]-->
...
<script src="<%=basePath %>xheditor/xheditor-1.2.2.min.js" type="text/javascript"></script>
<script src="<%=basePath %>xheditor/xheditor_lang/zh-cn.js" type="text/javascript"></script>
...
$(function(){
	DWZ.init("<%=basePath %>bin/dwz.frag.xml", {
...
<!-- 					<li id="switchEnvBox"><a href="javascript:">（<span>北京</span>）切换城市</a>
					...
					<li><a href="<%=basePath%>rest/user/logout">退出</a></li>
				</ul>
						...
						<ul class="tree treeFolder">
							<li><a href="tabsPage.html" target="navTab">系统管理</a>
								<ul>
									...
									<li><a href="<%=basePath %>rest/menu/menuList" target="navTab"  rel="menuManager">菜单管理</a></li>
									<%-- <li><a href="<%=basePath %>rest/role/roleList" target="navTab"  rel="roleManager">角色管理</a></li> --%>
									<li><a href="<%=basePath %>rest/userManager/userList" target="navTab"  rel="userManager">用户管理</a></li>
									<li><a href="<%=basePath %>rest/userGroup/groupList" target="navTab"  rel="group">用户组管理</a></li>
				...
				<div class="navTab-panel tabsPageContent layoutBox">
					<div class="page unitBox">
						<div class="accountInfo">
							...
							<div class="right">
								<p style="color:red"> <a href="http://weibo.com/dwzui" target="_blank"></a></p>
							</div>
							<p><span></span></p>
							<p>:<a href="http://weibo.com/dwzui" target="_blank"></a></p>
						</div>
