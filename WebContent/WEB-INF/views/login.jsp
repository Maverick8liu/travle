...
function loadVcode(){
	var vcode = $(".vcode");
	vcode.attr("src","<%=basePath %>rest/rest/verify.html?reload=(new Date()).getTime()");
}
...
<body onload="loadVcode()">
	<div id="login">
		<div id="login_header">
			<h1 class="login_logo">
				<a href="http://demo.dwzjs.com"></a><span style="font-size:3em;font-weight: lighter;">云汇管理系统 </span>
		...
		<div id="login_content">
			<div class="loginForm">
				<form action="<%=basePath %>rest/user/login" method="post">
					<p>
						<label>用户名：</label>
					...
					<p>
						<label>验证码：</label>
						<input class="code" type="text" name="verifyCode" size="4" />
						<span><img onclick="this.src=('<%=basePath %>rest/rest/verify.html?reload='+(new Date()).getTime())" class="vcode" src="/verify.html" width="75" height="24" alt=""/>
						<!-- <img src="../../themes/default/images/header_bg.png" alt="" width="75" height="24" /> -->
						</span>
					</p>
